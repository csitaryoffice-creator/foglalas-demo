...
export const DEMO_PRESETS = [
  ...
  makePreset({
    ...
    terminology: { provider: "Orvos", providerPlural: "Orvosok", customer: "Páciens", customerPlural: "Páciensek", service: "Vizsgálat", servicePlural: "Vizsgálatok", area: "Rendelés" },
    ...
    services: [
      ...
      { provider: 0, name: "Preventív konzultáció", description: "Általános megelőzési szempontok áttekintése demóadatokkal.", duration: 30, price: 16000, bufferAfter: 10 },
      { provider: 0, name: "Leletmegbeszélés", description: "Korábbi vizsgálati eredmények tájékoztató áttekintése.", duration: 20, price: 12000, bufferAfter: 10 },
      { provider: 0, name: "Általános kontroll", description: "Rövid, bemutató célú kontrollvizsgálat.", duration: 20, price: 10000, bufferAfter: 10 },
      { provider: 1, name: "Kontrollvizsgálat", description: "Rövid utánkövetési konzultáció.", duration: 20, price: 12000, bufferAfter: 10 },
      { provider: 1, name: "Belgyógyászati állapotfelmérés", description: "Általános belgyógyászati konzultáció fiktív adatokkal.", duration: 40, price: 22000, bufferAfter: 10 },
      { provider: 1, name: "Laboreredmény-konzultáció", description: "Laboreredmények tájékoztató jellegű átbeszélése.", duration: 25, price: 15000, bufferAfter: 10 },
      { provider: 1, name: "Vérnyomás-kontroll", description: "Rövid kontroll és konzultáció.", duration: 20, price: 12000, bufferAfter: 10 },
      ...
      { provider: 2, category: 1, name: "Táplálkozási konzultáció", description: "Étkezési szokások és célok közös áttekintése.", duration: 50, price: 22000, bufferAfter: 10 },
      { provider: 2, category: 1, name: "Alvás és stressz konzultáció", description: "Életmódbeli szokások tájékoztató áttekintése.", duration: 45, price: 20000, bufferAfter: 10 },
      { provider: 2, category: 1, name: "Életmód kontroll", description: "Korábbi javaslatok rövid utánkövetése.", duration: 30, price: 16000, bufferAfter: 10 },
      { provider: 3, category: 1, name: "Online utánkövetés", description: "Rövid online megbeszélés.", duration: 30, price: 14000 },
      { provider: 3, name: "Családorvosi konzultáció", description: "Általános, tájékoztató jellegű konzultáció.", duration: 30, price: 16000, bufferAfter: 10 },
      { provider: 3, category: 1, name: "Prevenciós tanácsadás", description: "Megelőzési lehetőségek áttekintése fiktív adatokkal.", duration: 40, price: 19000, bufferAfter: 10 },
      { provider: 3, category: 1, name: "Lelet- és gyógyszeráttekintés", description: "Bemutató célú dokumentum- és gyógyszerlista-áttekintés.", duration: 30, price: 17000, bufferAfter: 10 },
    ],
